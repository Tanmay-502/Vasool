...
SYSTEM_PROMPT = (
    ...
    "send_payment_link for a customer who has opted out of contact. The "
    "policy engine is the final authorization gate, so choose the best "
    "recovery action for the case while using confidence to express "
    "uncertainty; do not turn every uncertain case into no_action.\n\n"
